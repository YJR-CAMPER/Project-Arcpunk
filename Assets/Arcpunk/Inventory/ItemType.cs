...
namespace Arcpunk.Inventory
{
    ...
    public static class ItemDatabase
    {
        ...
        static ItemDatabase()
        {
            ...
            // ── 무기 ──
            Defs[(int)ItemType.ArcGun] = new ItemDef
            {
                Name = "Arc Gun", MaxStack = 1, Durability = 300,
                ToolTier = Voxel.ToolTier.Iron, IconIndex = 14,
                SpeedMultiplier = 1f,
            };
        }
            ...
            bool placeable, Voxel.BlockType blockType, int icon)
        {
            ...
            {
                Name = name, MaxStack = maxStack,
                IsPlaceable = placeable, BlockType = blockType,
                IconIndex = icon, SpeedMultiplier = 1f,
            };
        }
            ...
            int maxStack, int icon, float food = 0)
        {
            ...
            {
                Name = name, MaxStack = maxStack,
                IconIndex = icon, FoodValue = food, SpeedMultiplier = 1f,
            };
        }
            ...
            int durability, float speed, int icon)
        {
            Defs[(int)type] = new ItemDef
            {
                Name = name, MaxStack = 1,
                ToolTier = tier, ToolType = toolType,
                Durability = durability, SpeedMultiplier = speed,
                IconIndex = icon,
            };
        }
